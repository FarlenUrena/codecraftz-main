...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-6 z-[9999] flex h-11 w-11 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(37,211,102,0.3)] transition-transform hover:scale-105"
    >
